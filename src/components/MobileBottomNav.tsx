                ...
                {user ? (
                  <>
                    ...
                    <div className="space-y-1">
                      {[
                        { path: '/analytics', icon: Brain, label: 'Analytics & Insights', iconClass: 'text-cyan-500', bgClass: 'bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/40 dark:to-blue-950/40' },
