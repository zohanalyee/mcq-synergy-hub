...
import { BrainCircuit, Sparkles, FileText, Users, Briefcase, Target, GraduationCap, TrendingUp, MessageSquare, Database, ChevronRight, Wrench, ClipboardList } from 'lucide-react';
