...
const AdminContent = ({
  ...
  const isContentTab = !['submit-content', 'subjects', 'topics', 'job-tests', 'quizzes', 'question-bank', 'analytics', 'data-migration', 'review-duplicates', 'bulk-upload', 'dashboard', 'lms-structure', 'jobs', 'scholarships', 'inventory', 'documents', 'messages', 'feedback-analytics'].includes(activeTab);
