...
if (typeof g.window === 'undefined') {
  ...
  win.location = { href: 'https://www.mcqsai.com/', origin: 'https://www.mcqsai.com', pathname: '/', search: '', hash: '', protocol: 'https:', host: 'www.mcqsai.com', assign: noop, replace: noop, reload: noop };
