    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          <Link key="Grammar" to={`/custom-syllabus?topic=Grammar`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
            <p className="text-sm font-medium">Grammar</p>
            <p className="text-xs text-purple-600 mt-1">Practice →</p>
          </Link>
          <Link key="Vocabulary" to={`/custom-syllabus?topic=Vocabulary`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
            <p className="text-sm font-medium">Vocabulary</p>
            <p className="text-xs text-purple-600 mt-1">Practice →</p>
          </Link>
          <Link key="Comprehension" to={`/custom-syllabus?topic=Comprehension`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
            <p className="text-sm font-medium">Comprehension</p>
            <p className="text-xs text-purple-600 mt-1">Practice →</p>
          </Link>
          <Link key="Sentence Correction" to={`/custom-syllabus?topic=Sentence%20Correction`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
            <p className="text-sm font-medium">Sentence Correction</p>
            <p className="text-xs text-purple-600 mt-1">Practice →</p>
          </Link>
          <Link key="Synonyms" to={`/custom-syllabus?topic=Synonyms`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
            <p className="text-sm font-medium">Synonyms</p>
            <p className="text-xs text-purple-600 mt-1">Practice →</p>
          </Link>
          <Link key="Antonyms" to={`/custom-syllabus?topic=Antonyms`} className="p-3 border rounded-lg hover:bg-purple-50 text-center">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          <Link key="Pakistan Affairs" to={`/custom-syllabus?topic=Pakistan%20Affairs`} className="p-3 border rounded-lg hover:bg-blue-50 text-center">
          ...
          <Link key="World GK" to={`/custom-syllabus?topic=World%20GK`} className="p-3 border rounded-lg hover:bg-blue-50 text-center">
            <p className="text-sm font-medium">World GK</p>
            <p className="text-xs text-blue-600 mt-1">Practice →</p>
          </Link>
          <Link key="Science" to={`/custom-syllabus?topic=Science`} className="p-3 border rounded-lg hover:bg-blue-50 text-center">
            <p className="text-sm font-medium">Science</p>
            <p className="text-xs text-blue-600 mt-1">Practice →</p>
          </Link>
          <Link key="History" to={`/custom-syllabus?topic=History`} className="p-3 border rounded-lg hover:bg-blue-50 text-center">
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <Link key="Political Science" to={`/custom-syllabus?topic=Political%20Science`} className="p-3 border rounded-lg hover:bg-orange-50 text-center">
            <p className="text-sm font-medium">Political Science</p>
            <p className="text-xs text-orange-600 mt-1">Practice →</p>
          </Link>
          <Link key="Sociology" to={`/custom-syllabus?topic=Sociology`} className="p-3 border rounded-lg hover:bg-orange-50 text-center">
            <p className="text-sm font-medium">Sociology</p>
            <p className="text-xs text-orange-600 mt-1">Practice →</p>
          </Link>
          <Link key="Psychology" to={`/custom-syllabus?topic=Psychology`} className="p-3 border rounded-lg hover:bg-orange-50 text-center">
            <p className="text-sm font-medium">Psychology</p>
            <p className="text-xs text-orange-600 mt-1">Practice →</p>
          </Link>
          <Link key="History" to={`/custom-syllabus?topic=History`} className="p-3 border rounded-lg hover:bg-orange-50 text-center">
            <p className="text-sm font-medium">History</p>
            <p className="text-xs text-orange-600 mt-1">Practice →</p>
          </Link>
          <Link key="Geography" to={`/custom-syllabus?topic=Geography`} className="p-3 border rounded-lg hover:bg-orange-50 text-center">
