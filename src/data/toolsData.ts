...
export const ALL_TOOLS: ToolDefinition[] = [
  ...
  { id: 'qr-generator', name: 'QR Code Generator', description: 'Generate QR codes from text', category: 'Generators', icon: QrCode, popular: true, href: '/tools/qr-generator',
    seoDescription: 'Free QR code generator. Create QR codes from any text, URL, or data instantly. Download as PNG for print or digital use.',
    howToUse: ['Enter text or URL to encode', 'QR code generates automatically', 'Download the QR code as an image'] },
