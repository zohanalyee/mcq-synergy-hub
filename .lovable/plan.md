...
Facts will be read from the official admission pages before writing, and each page will cite its source with an outbound link plus a "verified on <date>" line:
