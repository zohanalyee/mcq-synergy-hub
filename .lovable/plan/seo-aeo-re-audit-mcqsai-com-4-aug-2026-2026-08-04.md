...
1. Phase 1 — SAB-5-items karein (I-1, I-3, I-8, I-9 + build-guard). I-1 sabse-zaroori-hai, poora-Phase-1-hi-karna-behtar-hai.

2. Urdu-Indexing — FILHAL ENGLISH-ONLY (no-change). /ur/-path-URLs future-mein-alag-project-ki-tarah-sochenge.

&nbsp;

Phase 1 shuru karein.