...
Approved — Phase 1 shuru karein, sab-cheezein jaisa-report-mein-diya-hai:

&nbsp;

1. Referral-tracking: campaign_visits table, profiles.signup_campaign column, get_campaign_stats RPC, admin-Campaigns-dashboard-card

2. Mobile-onboarding-fixes: confetti-ek-baar-hi-chale (prefers-reduced-motion respect karein), compact-modal-mobile-ke-liye, exam-chooser (MDCAT/SPSC-CCE/FPSC/STS-NTS/Class-9-12), "Start-Practicing" ab Larkana-starter-test par le-jaye (poori-list-nahi), "results-save-hote-hain-signup-ke-baad" wali-reassurance-line, brand-tokens-use-karein (colors-consistent)

&nbsp;

QR-code URL yeh-hoga: https://mcqsai.com/larkana?utm_source=library_banner&utm_medium=qr&utm_campaign=larkana_library

&nbsp;

Phase-2 (email-Resend-setup) alag-se-baad-mein-karenge — abhi-sirf-Phase-1-shuru-karein.

&nbsp;

Har-item-complete-hone-par-summary-dein.