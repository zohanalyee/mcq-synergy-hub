...
1. Reuse-time-style-guard (turant, zero-cost) — abhi-lagayen.

2. Exam-Tier-system — YEH-ZAROORI-hai, approve. Migration + backfill + reuse-rule (same-tier-only, strict).

3. Cleanup-sweep (48-flagged-rows) — HAAN, karein — flag-karein review-ke-liye (delete-nahi), sirf-clerical/mid-tier-tests-mein.

4. Dashboard-labelling-fix ("AI-attempts"-vs-"saved-questions") — approve.

&nbsp;

VERIFICATION-ZAROORI: 12:00-UTC-run-ke-baad-CONFIRM-karein:

- stop_reason-badla-hai-ya-nahi

- topics_processed > 0-hai-ya-nahi

- content_items-count-barha-ya-nahi

&nbsp;

Agar-12:00-UTC-run-par-bhi-0-aaye, TURANT-batayen — get_autofill_queue-khud-khali-hai-ya-koi-aur-masla-hai.

&nbsp;

Build/typecheck-clean-hone-ke-baad publish-karein.