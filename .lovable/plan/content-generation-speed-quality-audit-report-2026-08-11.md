...
Approved — sab-5-phases, is-order-mein:

Phase 1 (Unblock) — TURANT, sabse-zaroori-fix hai.

Phase 5 (Backfill) — Phase-1-ke-turant-baad, kyunki-yeh-FREE-hai (no-AI-cost) aur-turant-topics-ko-indexable-bana-dega.

Phase 2 (Throttle-barhana) — Priority-order-yehi-rakhein jo-diya-hai: MDCAT-pehle, phir-Punjab/Sindh-boards, phir-PPSC/FPSC.

Phase 3 (Sprint-Mode) — approved.

Phase 4 (Quality-Gate) — approved, ZAROORI-hai speed-ke-sath-quality-bhi-maintain-rakhne-ke-liye.

Phase-1-2-shuru-karein.