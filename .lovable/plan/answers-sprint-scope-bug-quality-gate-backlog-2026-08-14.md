...
1. Sprint-scope-MDCAT-par-reset-karein (15/topic, 600-budget).

2. Preset-selection-mein SAFETY-WARNING-add-karein (0-match-ho-to-chup-chaap-save-na-ho).

3. Scope-matching-BROADEN-karein (subject-level-inheritance, taake-MDCAT-Past-Papers-jaise-parent-subjects-apne-saare-child-topics-cover-karein).

4. Sprint-Scope-Preview add-karein panel-mein (top-10-matching-topics-dikhen).

5. Quality-Gate hourly-auto-review add-karein (200/run, quota-safe-guard-ke-sath).
